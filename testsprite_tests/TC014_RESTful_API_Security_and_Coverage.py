...
async def run_test():
    ...
    try:
        ...
        # Navigate to 'Gestión de Usuarios' to test user-related API endpoints with JWT authentication.
        frame = context.pages[-1]
        ...
        # Navigate to 'Gestión de Productos' to test product-related API endpoints with JWT authentication and perform CRUD operations.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/aside/nav/ul/li[11]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Navigate to 'Evaluación y Scoring' to test scoring-related API endpoints with JWT authentication and perform CRUD operations.
        frame = context.pages[-1]
