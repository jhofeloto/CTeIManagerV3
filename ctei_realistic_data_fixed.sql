...
-- Esquema compatible con base de datos existente
-- =============================================
...
-- Usando solo columnas que existen en el esquema actual
-- =============================================

INSERT OR IGNORE INTO products (
  id, project_id, product_code, product_type, description, is_public,
  doi, url, publication_date, journal
) VALUES
...
'10.1038/s41598-024-12345-6', NULL, '2024-03-15', 'Nature Scientific Reports'),
...
NULL, 'https://github.com/ctei-unal/diagnet', '2024-06-20', NULL),
...
'10.1016/j.compag.2024.108234', NULL, '2024-07-10', 'Computers and Electronics in Agriculture'),

(4, 2, 'PROTOTYPE-COFFEECHAIN-001', 'PROTOTYPE', 'CoffeeChain: Prototipo de Plataforma Blockchain para Trazabilidad Cafetera', 1,
NULL, 'https://coffeechain-demo.eafit.edu.co', '2024-08-15', NULL),
...
NULL, 'https://smart.manizales.gov.co', '2024-05-30', NULL),

(6, 3, 'DATASET-ENVDATA-001', 'DATASET', 'Conjunto de Datos de Monitoreo Ambiental Urbano: Manizales 2024', 1,
'10.5194/essd-2024-123', 'https://zenodo.org/record/8901234', '2024-09-01', NULL),
...
NULL, 'https://github.com/javeriana/chemvr', '2024-04-25', NULL),
...
'10.1007/s10956-024-09876-1', NULL, '2024-08-20', 'Journal of Science Education and Technology'),
...
'10.1038/s41588-024-01543-2', NULL, '2024-11-15', 'Nature Genetics'),

(10, 5, 'DATABASE-GENOMIC-COL-001', 'DATABASE', 'Base de Datos Genómica de Cáncer Colorrectal en Población Colombiana', 0,
NULL, 'https://genomics.udea.edu.co/colorectal-db', '2024-10-10', NULL),
