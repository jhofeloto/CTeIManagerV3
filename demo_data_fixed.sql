...
INSERT OR IGNORE INTO institutions (name, type, country, city, website) VALUES 
('Universidad Tecnológica del Chocó', 'UNIVERSIDAD', 'Colombia', 'Quibdó', 'https://utch.edu.co'),
('SINCHI', 'INSTITUTO', 'Colombia', 'Bogotá', 'https://sinchi.org.co'),
('Universidad Nacional', 'UNIVERSIDAD', 'Colombia', 'Medellín', 'https://unal.edu.co');
